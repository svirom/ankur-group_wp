...
//ajax send contacts/msgbox form
add_action('wp_ajax_form'       , 'contacts_form');
add_action('wp_ajax_nopriv_form', 'contacts_form');
...
//ajax send aircraft/helicopter form
add_action('wp_ajax_form2'       , 'aircraft_form');
add_action('wp_ajax_nopriv_form2', 'aircraft_form');

function aircraft_form() { 
